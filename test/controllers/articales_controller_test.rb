...
class ArticalesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post articales_url, params: { articale: { description: @articale.description, string: @articale.string, title: @articale.title } }
  #   end
  ...
  #   patch articale_url(@articale), params: { articale: { description: @articale.description, string: @articale.string, title: @articale.title } }
